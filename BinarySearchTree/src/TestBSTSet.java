...
public class TestBSTSet {
    public static void main(String[] args) {
        ...
        int[] d1 = {5, 0, 16, 3, 2, 11, 8, 9, 4}; //no repetitions
        int[] d2 = {7, 6, 5, 1, 2, 2, 4, 9, 8, 20, 32, 3, 17};//with repetitions
        int v1 = 16; //value in set d1
        int v2 = 10; //value not in set d1
        int v3 = 0; //another value in set d1

        int[] d3 = {11, 2, 9, 8, 30}; //has elements in common with d1
        int[] d4 = {6, 1, 10, 12, 5}; //no common elements with d1

        int[] d6 = {2, 4, 6, 8, 16, 10, 14, 15, 18, 24, 22, 35, 28, 29}; //almost sorted array
        int[] d7 = {2, 3, 6, 10, 16, 22, 28, 35}; // sorted; has elements in common with d6
